...
";
      ...
      ";
        ...
        if (($context["href"] ?? null)) {
            ...
            if (($context["is_admin"] ?? null)) {
                ...
                echo "?destination=/admin/structure/block/block-content\" style=\"color:aqua\">Edit</a>
        ";
            }
            // line 52
            echo "      ";
  ...
  ";
    ...
    {
        return array (  96 => 52,  90 => 50,  87 => 49,  85 => 48,  78 => 44,  75 => 43,  72 => 42,  67 => 56,  65 => 42,  60 => 39,  58 => 36,  57 => 35,  56 => 33,);
    }
...
{% block content %}
      ...
      {% if href %}
       {% if is_admin %}
        <a href=\"/block/{{href}}?destination=/admin/structure/block/block-content\" style=\"color:aqua\">Edit</a>
        {% endif %}
      {% endif %}      
...
", "themes/bit/block.html.twig", "C:\\Server\\OSPanel\\domains\\bitcoin\\themes\\bit\\block.html.twig");
    }
}
